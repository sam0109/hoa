#!/usr/bin/env bash
# ============================================================================
# setup-github.sh — Configure GitHub repository best practices for HoA
#
# Sets up branch protection, labels, PR templates, issue templates, and
# repo settings to enforce the guardrails described in README.md and
# LESSONS.md. Idempotent — safe to re-run.
#
# Prerequisites:
...
#
# Usage:
#   bash scripts/setup-github.sh              # auto-detect repo from git remote
#   bash scripts/setup-github.sh sam0109/hoa  # explicit repo
# ============================================================================
...
if [[ -z "$REPO" ]]; then
  echo "ERROR: Could not detect repo. Pass it as an argument: bash scripts/setup-github.sh owner/repo"
  exit 1
fi
